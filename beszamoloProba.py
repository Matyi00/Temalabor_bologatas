...
def array_has_signal(array):
    ...
    return (max_difference > 0.4) and max_greater_than_zero and min_less_than_zero and max_in_range and min_in_range
...
if __name__ == "__main__":
    ...
    gauss = scipy.ndimage.gaussian_filter1d(vertical_array_landmarks, 4.5)

    for i in range(len(gauss)):
        if array_has_signal(gauss[:i]):
            # print("bologatas", bologatas_counter)
            bologatas_counter += 1
            vertical_array_procrustes.append(1)
